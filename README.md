...
1. What are the main differences between a class-based and a functional component?
  Class based allows the use of the built in methods, uses render

2. When does a componentWillMount function be called? What about a componentDidUpdate?
  Just before mounting
  After any relevant state or props are updated/changed

3. Define stateful logic.
    Code using both states and hooks

4. What are the three step of creating a successful test? What is done in each phase? 
  Arrange: render relevant components
  Act: Sim user interaction, filling forms, clicking buttons etc
  Assert: Essentially making declarations about the results of the previous step